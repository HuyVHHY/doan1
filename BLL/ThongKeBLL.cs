...
namespace BLL
{
    public class ThongKeBLL
    {
        ...
        {
            return thongKeHoaDonDAO.Instance.thongKethangNhap(thang, nam);
        }
        public List<thongKe> dsNhapThang(string nam)
        {
            return thongKeHoaDonDAO.Instance.thongKeNamNhap(nam);
        }

        //xuaat

        public List<thongKe> dsBanNgay( string thang,string nam)
        {
            return thongKeHoaDonDAO.Instance.thongKethang(thang, nam);
        }
        public List<thongKe> dsBanThang(string nam)
        {
            return thongKeHoaDonDAO.Instance.thongKeNam(nam);
        }
        ...
        public void inthongKethang(string thang, string nam)
        {
            ...
            thongke = thongKeHoaDonDAO.Instance.inThongKethang(thang, nam);
        ...
        public void inthongKeNam(string nam)
        {
            ...
            exRange.Range["C2:E2"].Value = "thống kê";
            DataTable thongke = new DataTable();
            thongke = thongKeHoaDonDAO.Instance.inthongKeNam(nam);
        ...
        //----------------------------------------
        // thống kê nhập
        public void inThongKetThangNhap(string thang, string nam)
        {
            // Khởi động chương trình Excel
            COMExcel.Application exApp = new COMExcel.Application();
            COMExcel.Workbook exBook;
            ...
            DataTable thongke = new DataTable();
            thongke = thongKeHoaDonDAO.Instance.inthongKethangNhap(thang, nam);
            exRange.Range["A11:F11"].Font.Bold = true;
            exRange.Range["A11:F11"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["C11:F11"].ColumnWidth = 12;
            exRange.Range["A11:A11"].Value = "STT";
            exRange.Range["B11:B11"].Value = "tuần";
            exRange.Range["C11:C11"].Value = "doanh thu"; ;
            for (hang = 0; hang < thongke.Rows.Count; hang++)
            {
        ...
        public void inThongKetNamNhap(string nam)
        {
            // Khởi động chương trình Excel
            COMExcel.Application exApp = new COMExcel.Application();
            COMExcel.Workbook exBook;
            ...
            DataTable thongke = new DataTable();
            thongke = thongKeHoaDonDAO.Instance.inthongKeNamNhap(nam);
